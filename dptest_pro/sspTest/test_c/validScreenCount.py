...
screenCount = res_date['data'].get("validScreenCount")
# print(res_date['data'].get("screenCount"))
print(screenCount)


# 执行SQL查询
sql_validScreenCount = get_media_validScreenCount(2028, '2019-02-14',conn = connect )
sCount = sql_validScreenCount[0].get("SUM(request_screens)")
print(sCount)
# 判断 接口数据与数据库查询结果

if screenCount == sql_validScreenCount:
    print("成功了")
