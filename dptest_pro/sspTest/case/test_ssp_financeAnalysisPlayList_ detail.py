...
FinanceAnalysisPlayList_detail_data = parameter.FinanceAnalysisPlayList_detail_data
set_dp_interface = utilsInterface.set_dp_interface

class test_queryentry_ssp_analysisPlayList_detail (unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        print("queryentry_ssp_analysisPlayList(数据明细)接口测试开始")
    ...
    def test_analysisPlayListDetailLen(self):
        print("开始测试test_analysisPlayListDetailLen")
        # 执行接口查询
        self.res_date = set_dp_interface(url=interface.get("queryentry_url") + sspFinanceAnalysisPlayList,data = FinanceAnalysisPlayList_detail_data)
    ...
    @skip_dependon(depend="test_analysisPlayListDetailLen")
